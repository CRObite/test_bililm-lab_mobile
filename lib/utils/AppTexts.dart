class AppText {
  ...
  static String enterPIN = 'PIN кодты енгізіңіз';
  static String setPINDescription = 'Бұл пин код кейінірек жылдам кіру үшін пайдаланылады *';
  static String setPINAgain = 'PIN кодын қайта енгізіңіз *';
  static String enterPINDescription = 'Тексеру үшін және pin кодын немесе биометрияны қолданыңыз *';
  static String forgotPIN = 'PIN кодты ұмыттыңыз ба?';
  static String reset = 'Қайта';
  static String confirm = 'Растау';
  static String fill = 'PIN кодтары бірдей емес';
