...
class AppColors{
  static Color colorButton = const Color(0xFF566DF6);
  static Color colorLighterBlue = const Color(0xFF97A4F5);
  static Color colorTextFiledStoke = const Color(0xFFADADAD);
