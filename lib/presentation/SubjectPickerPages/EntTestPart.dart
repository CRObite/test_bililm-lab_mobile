        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              CustomDropDown(dropItems: dropItems, hint: AppText.selectFirstSubject,onSelected: onSelectFirstSub,),
              const SizedBox(
                height: 16,
              ),
              IgnorePointer(
                  ignoring: firstSubWasNotSelected,
                  child: CustomDropDown(dropItems: dropItemsSecond, hint: AppText.selectSecondSubject)
              ),
              const SizedBox(
                height: 16,
              ),
